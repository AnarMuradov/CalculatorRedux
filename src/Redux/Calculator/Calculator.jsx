...
import { Sum,minus } from './CalculatorSlice'
...
export function Calculator() {
  ...
  return (
    <div>
        ...
        <button onClick={()=>dispatch(Sum([parseInt(num1),parseInt(num2)]))}>+</button>
        <button onClick={()=>dispatch(minus([parseInt(num1),parseInt(num2)]))}>-</button>
        <h1>{count}</h1>
